...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        queries = self.W_q(x)
        values = self.W_v(x)
        keys = keys.view(b, num_tokens, self.num_h, self.head_d)
        values = values.view(b, num_tokens, self.num_h, self.head_d)
        queries = queries.view(b, num_tokens, self.num_h, self.head_d)
        ...
        context_vec = context_vec.contiguous().view(b, num_tokens, self.d_o)
